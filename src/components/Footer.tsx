...
// УСЛОВИЯ ДОПУСКА/ КРИТЕРИЙ:
// •Тотал меньше 70 — минус стипендия

// •Тотал меньше 50 — летник  
  
// •Регтерм меньше 50 — летник  
  
// •РегМид меньше 25 — летник  
  
// •РегЭнд меньше 25 — летник  
  
// •При обнаружении списывания — ОТЧИСЛЕНИЕ