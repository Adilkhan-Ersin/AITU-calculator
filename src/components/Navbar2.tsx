...
//         ref={combinedRef}
//         className={cn(
//           'sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 md:px-8 [&_*]:no-underline',
//           className
//         )}
//         {...props}
//       >
...
//                     {logo}
//                   </div> */}
//                   <span className="hidden font-bold text-xl sm:inline-block">Evalis</span>
//                 </button>
//               </div>
//             </div>
//             {/* Right side */}
...
//                         }}
//                         className={cn(
//                           'text-muted-foreground hover:text-primary font-medium transition-colors cursor-pointer group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50',
...
// You can keep default navigation links or remove them
// const defaultNavigationLinks: Navbar08NavItem[] = [
//   { label: 'Home', href: '/' },
  ...
  (
    ...
    return (
      <header
        ref={combinedRef}
        className={cn(
          'sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 md:px-8',
          className
        )}
        {...props}
      >
